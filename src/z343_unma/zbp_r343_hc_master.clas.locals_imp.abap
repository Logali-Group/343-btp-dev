class lcl_buffer definition.
  ...
  public section.
    ...
    types: begin of ty_buffer_master.
             include type zhc343_master as data.
...
class lhc_HCMMaster implementation.
  ...
  method update.
    ...
    loop at entities into data(ls_entities).
      ...
      select single * from zhc343_master
...
class lsc_Z_R_HC_MASTER definition inheriting from cl_abap_behavior_saver.
  protected section.
...
class lsc_Z_R_HC_MASTER implementation.
  ...
  method save.
    ...
    data: lt_data_created type standard table of zhc343_master,
          lt_data_updated type standard table of zhc343_master,
          lt_data_deleted type standard table of zhc343_master.
    ...
    if lt_data_created is not initial.
      insert zhc343_master from table @lt_data_created.
    endif.
    ...
    if lt_data_updated is not initial.
      update zhc343_master from table @lt_data_updated.
    endif.
    ...
    if lt_data_deleted is not initial.
      delete zhc343_master from table @lt_data_deleted.
    endif.
